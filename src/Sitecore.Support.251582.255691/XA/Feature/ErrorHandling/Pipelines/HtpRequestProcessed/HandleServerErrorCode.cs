...
namespace Sitecore.Support.XA.Feature.ErrorHandling.Pipelines.HtpRequestProcessed
{
  public class HandleServerErrorCode : HttpRequestProcessor
  {
    ...
    public override void Process(HttpRequestArgs args)
    {
      ...
      {
        #region FIX 251582
        FieldInfo field = typeof(Sitecore.Sites.SiteContext).GetField("info", BindingFlags.Instance | BindingFlags.NonPublic);
        SiteInfo site = (field == null) ? null : field.GetValue(Context.Site) as SiteInfo;
        #endregion
